...
#ifndef _xMPNetwork_CPP
#define _xMPNetwork_CPP
...
int downloadFile(std::string url, std::string &response) {
	...
	if (curl != NULL) {
        ...
        uAgent << "User-Agent: LeX/2.0 (SDL/OpenGL; U; PSP; en-CA; libC:" << LIBCURL_VERSION_MAJOR << "." << LIBCURL_VERSION_MINOR << "." << LIBCURL_VERSION_PATCH << ";) xMangaPSP/" << _MAJOR_VERSION << "." << _MINOR_VERSION << " API/" << _API_VERSION;
