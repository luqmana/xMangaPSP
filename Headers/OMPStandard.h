/*
 * $Id: OMPStandard.h 84 2009-12-31 03:42:09Z chaotic@luqmanrocks.co.cc $
 * 
...
#ifndef _OMPStandard_H
#define _OMPStandard_H
...
typedef std::map <std::string, std::string> OMStrArray;
