/*
 * $Id: OMText.h 81 2009-12-29 02:58:45Z chaotic@luqmanrocks.co.cc $
 * 
...
class OMText {
	...
	public:
		 ...
		 */
		OMText(const std::string& fontFile, int size);
		 ...
		 * @param int size Point size.
		 */
		OMText(const std::string& pakFile, const std::string& fontFile, int size);
		...
		/**
 		 ...
 		 * @param const char* text The text to draw.
 		 */
		OMTexture getGlTexture(const char* text, ...);
