...
{
	pgeFile* s = (pgeFile*)malloc(sizeof(pgeFile) + sizeof(pgeFileStream));
...
pgeFile* pgeFileOpenMemory(char* data, int size)
{
	pgeFile* s = (pgeFile*)malloc(sizeof(pgeFile) + sizeof(pgeMemoryStream));
...
int pgeFileMemoryClose(pgeFile* s)
{
	...
	{
		free(((pgeMemoryStream*)s->_stream)->data);
